...
'this returns occurance of highest character from each list and stores in another new dictionary - final_dic'
'final_dic is again used to find the max occurance among the list of sentences'
